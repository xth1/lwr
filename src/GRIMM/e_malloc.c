...
/* allocate memory, and abort if error */
/* void *e_malloc(int size, char *msg)
   equivalent to malloc(size) if successful;
   if unsuccessful, prints error message including spot for msg, and aborts */
...
void *e_calloc(int n, int s, char *msg)
{
    void *p;
